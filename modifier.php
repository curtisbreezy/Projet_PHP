...
<head>
  ...
  <title>Blog PHP-Modifier un post</title>
  <!-- Bootstrap core CSS-->
...
<h2 class="cold-md-12 m-3"> Modifier un article </h2>
				
		<form method="POST" action="modifierpost.php">
			<?php while($a = $articles->fetch()){?>
						
						<h2 class=" mt-4 mb-3"> <?=$a['titrepost'] ?> </h2> </br>
						</br>
						<textarea class="col-md-12"><?=$a['textepost'] ?></textarea>
						<input type="submit" name="modifier"> </button>
			<?php }?>				
			</br>
		 </br>
		</form>
