...
<html lang="fr">
  ...
  <body id="page-top">
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Allons plus loin, ensemble.</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Mourad Kheloui- Développeur PHP</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="CV_2018_PHP.pdf">Plus d'information sur mon parcours</a>
          </div>
        </div>
      </div>
    </header>
    ...
    </section><section class="bg-dark text-white">
