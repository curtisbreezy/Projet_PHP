       ...
       <div class="container-fluid">
            ...
            <div class="card mb-3">
			  <div class="card-body text-center">
				...
				</br>Rédigé par : <?= htmlspecialchars($a['auteurpost']) ?> </br>
				<hr/>
				<p> Posté le <?= htmlspecialchars($a['datepost']) ?> </p></div>
              
			  
		
             
			  <a href="index.php?page=edit_post&id=<?= htmlspecialchars($a['id_article']) ?> type="submit" class="btn btn-warning" name="modifier" id="modifier" Value="modifier"> Édition </a>
			  <br/>
			  <a href="index.php?page=delete_post&id=<?= htmlspecialchars($a['id_article']) ?> type="submit" class="btn btn-danger" name="modifier" id="modifier" Value="modifier"> Suppression </a>
			  <br/>
			  <a href="index.php?page=validate&id=<?=htmlspecialchars($a['id_article'])?>&validate=<?=htmlspecialchars($a['validate'])?> type="submit" class="btn btn-danger"> A valider </a>
