            ...
            <table class="table table-bordered" method="post" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="supprimercommm.php?id=<?= $c['id_commentaire'] ?>">Supprimer le commentaire</a></td>
            ...
            <table class="table table-bordered" method="post" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="supprimercomm.php?id=<?= $r['id_commentaire'] ?>">Supprimer le commentaire</a></td>
